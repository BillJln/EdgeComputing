...
#
# # 改成自己训练所需要的类
# classes=['g_s','g_l','g_r','g_t_a','r_s','r_l','r_r','r_t_a','y','n']
#
#
...
#
#     # 自定义数据集文件夹的名称
#     dataset_name = 'VOC2012HLD'
#
#     # VOC数据集标注文件
#     annotation_filepath = abs_path + dataset_name + '/Annotations/'
#
#     # 数据集划分文件
#     txtfile_dir = abs_path + dataset_name + '/ImageSets/Main/'
#
#     # coco训练图像输入的文件夹
