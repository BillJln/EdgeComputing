...
def fitness(x):
    ...
    w = [0.0, 0.0, 0.0, 1]  # 改了权重，只以mAP@0.5:0.95为准
    return (x[:, :4] * w).sum(1)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='pt/yolov5n.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='./models/yolov5n.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/Drive.yaml', help='dataset.yaml path')
